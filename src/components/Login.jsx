...
const Login = () => {
  ...
  return (
    ...
    <h6 className = "w-21 font-bold my-2 p-2 text-white text-left">{siginform?"sing Up" : "Sing In"}</h6>
      ...
      <button className='bg-blue-300 text-black p-1 border 1px solid rounded-sm'>{siginform?"sing Up" : "Sing In"}</button>
      
      <p className='py-4 cursor-pointer' onClick={togglesinform}> {siginform? "New to Netflix? sing Up Now" : "Already registered? Sing In Now"}</p>
